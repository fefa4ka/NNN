...
static vector *      vector_map(vector *v, float operation(float));
static vector *      vector_map_param(vector *v, float operation(float, float), float operation_param);
...
static
vector *
vector_map(vector *v, float operation(float)) {
    VECTOR_FOREACH(v) {
        VECTOR(v, index) = operation(VECTOR(v, index));
    }
...
static
vector *
vector_map_param(vector *v, float operation(float, float), float operation_param) {
    VECTOR_FOREACH(v) {
        VECTOR(v, index) = operation(VECTOR(v, index), operation_param);
    }
